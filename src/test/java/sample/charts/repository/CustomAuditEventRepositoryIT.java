...
import sample.charts.config.audit.AuditEventConverter;
import sample.charts.domain.PersistentAuditEvent;
...
import static sample.charts.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
